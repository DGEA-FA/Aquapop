...
test_that("calculate_mf_ratio() retourne le ratio simplifié correctement", {
  ...
  expect_equal(calculate_mf_ratio(0, 7), "0:1")
  expect_equal(calculate_mf_ratio(9, 0), "1:0")
  expect_equal(calculate_mf_ratio(2, 8), "1:4")
  expect_equal(calculate_mf_ratio(8, 2), "4:1")
})

test_that("calculate_mf_ratio() retourne NA_character_ si les deux valeurs sont nulles", {
  expect_identical(calculate_mf_ratio(0, 0), NA_character_)
})

test_that("calculate_mf_ratio() retourne toujours un caractère avec un seul ':'", {
