test_that("cpue_abondance_table() retourne un tableau structuré avec CPUE numériques", {
  ...
  expect_true(all(c(
    "groupe", "abondance", "proportion",
    "mf_ratio", "cpue", "ic95"
  ) %in% names(tab)))
  
  expect_type(tab$cpue, "double")
  expect_type(tab$ic95, "character")
