# ---
  # Fichier : maturite_fonctions_externes.R
  # Origine : Fonctions métier fournies par Mainguy et al. (collaborateurs externes)
  # Usage   : Fonctions utilisées dans la section "Longueur à maturité" de l'application AquaPop
  # Statut  : Ne pas modifier ce fichier sans validation préalable
#
# Remarques :
