courbe_croissance_comparaison <- function(data) {
  ...
  #voir s'il faudrait mettre les parametres des equations realise avec d'autres modeles comme dans le manuel de Mainguy (of course slmt s'ils convergent). 
...
tableresult <- data.frame(Methode=c("Von Bertalanffy",
                                    "Gompertz" ,
                                    "Logistique"
                                    ),
                          Linf=c(
