L50_selection_modeles <- function(df, modlogit.l, modprobit.l, modcloglog.l, modlogit.add, modprobit.add, modcloglog.add, modlogit.int, modprobit.int, modcloglog.int) {
...
model.sel.TABLE[model.sel.TABLE == "logit.L"] <- "Longueur (lien logit)"
model.sel.TABLE[model.sel.TABLE == "logit.ADD"] <- "Longueur + Sexe (lien logit)"
model.sel.TABLE[model.sel.TABLE == "logit.INT"] <- "Longueur + Sexe + Longueur:Sexe (lien logit)"

model.sel.TABLE[model.sel.TABLE == "probit.L"] <- "Longueur (lien probit)"
model.sel.TABLE[model.sel.TABLE == "probit.ADD"] <- "Longueur + Sexe (lien probit)"
model.sel.TABLE[model.sel.TABLE == "probit.INT"] <- "Longueur + Sexe + Longueur:Sexe (lien probit)"

model.sel.TABLE[model.sel.TABLE == "cloglog.L"] <- "Longueur (lien cloglog)"
model.sel.TABLE[model.sel.TABLE == "cloglog.ADD"] <- "Longueur + Sexe (lien cloglog)"
model.sel.TABLE[model.sel.TABLE == "cloglog.INT"] <- "Longueur + Sexe + Longueur:Sexe (lien cloglog)"
...
#BICmodelsel[BICmodelsel == "logit.L"] <- "Longueur"
#BICmodelsel[BICmodelsel == "logit.ADD"] <- "Longueur + Sexe"
#BICmodelsel[BICmodelsel == "logit.INT"] <- "Longueur + Sexe + Longueur:Sexe"
